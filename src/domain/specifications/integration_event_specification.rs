//! Specifications for IntegrationEvent aggregate
//!
...
// Each predicate implements `Specification<IntegrationEvent>` and can be combined
...
//
// pub struct ActiveIntegrationEventSpec;
// impl Specification<IntegrationEvent> for ActiveIntegrationEventSpec {
//     fn is_satisfied_by(&self, e: &IntegrationEvent) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
