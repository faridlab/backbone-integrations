//! Specifications for IntegrationConnector aggregate
//!
...
// Each predicate implements `Specification<IntegrationConnector>` and can be combined
...
//
// pub struct ActiveIntegrationConnectorSpec;
// impl Specification<IntegrationConnector> for ActiveIntegrationConnectorSpec {
//     fn is_satisfied_by(&self, e: &IntegrationConnector) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
