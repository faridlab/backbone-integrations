//! Domain policy for IntegrationAccount aggregate
//!
...
/// Domain policy for IntegrationAccount — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<IntegrationAccount>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type IntegrationAccountDomainPolicy = PermitAllPolicy<IntegrationAccount>;
